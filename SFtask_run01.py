...
instructions = visual.TextStim(win, text=(
    "Welcome to the task!\n\n"
    "During the task, you will see patterns (Gabor patches) on the screen.\n"
    "Occasionally, the fixation cross at the center will turn GREEN.\n"
    "When this happens, press the button as quickly as possible.\n\n"
    "Press 't' to begin the task (this signal comes from the scanner)."
...
data_file = f"Subject_{subject_id}_Run_{run_number}_RT.csv"
