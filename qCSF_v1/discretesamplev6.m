...
% This version disables some features of the original program, to ensure
% compatibility with MATLAB versions earlier than 7.0   % from Lesmes
%
%   x = discretesamplev6(p, n)
...
%   Lightly modified to run in MATLAB version 6 by Luis Lesmes, On
%   October 1, 2009
%% main
